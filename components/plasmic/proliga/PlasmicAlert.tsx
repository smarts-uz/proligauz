...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: 1mEeXoy7thbq/css

import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: b0eE7qHpNe6S/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jAvfl, {
          [sty.freeBoxnoBody__jAvflLznTr]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__jAvflnGciv]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__jAvflnVSc]: hasVariant($state, "noIcon", "noIcon")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__iOxuw, {
            [sty.freeBoxnoIcon__iOxuwnVSc]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg___7WaQa)}
                role={"img"}
              />
            ),
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__b7Nbr, {
            [sty.freeBoxnoHeader__b7NbrnGciv]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon__b7NbrnVSc]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__xknpA, {
              [sty.freeBoxnoBody__xknpALznTr]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader__xknpAnGciv]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
